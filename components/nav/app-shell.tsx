...
export function AppShell({children}:{children:React.ReactNode}){
 ...
 return <div className="g3-shell flex overflow-hidden">
   {!isVitrine&&<><AppNav/><button type="button" aria-label="Ouvrir le menu" onClick={()=>{setMobileOpen(true);window.dispatchEvent(new Event("gen3ia:open-nav"))}} className="g3-mobile-menu">☰</button></>}
