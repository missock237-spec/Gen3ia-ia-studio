...
export default function StudioPage() {
  ...
  return <main className="min-h-screen bg-[#070a12] text-white p-5 md:p-8"><div className="mx-auto max-w-7xl">
    <header className="mb-8 flex items-center justify-between"><div><div className="text-xs tracking-[.3em] text-violet-300">GEN3IA AI STUDIO</div><h1 className="mt-2 text-3xl font-bold">Studio d’agents IA</h1><p className="mt-2 text-white/60">Créez, équipez, testez et déployez des agents autonomes dans un environnement contrôlé.</p></div><div className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm">{user ? "Compte connecté" : "Connexion requise"}</div></header>
