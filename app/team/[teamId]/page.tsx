  ...
  return (
    <main className="min-h-screen bg-[#f6f4ef] text-neutral-900">
      <div className="mx-auto max-w-5xl space-y-8 px-4 py-10 md:px-8 md:py-14">
        {loading && (
          <div className="rounded-3xl border border-neutral-200/80 bg-white p-8 text-center shadow-[0_2px_10px_rgba(15,23,42,0.05)]">
        ...
        {!loading && !team && (
          <div className="anim-scale-in mx-auto max-w-md rounded-3xl border border-neutral-200/80 bg-white p-8 text-center shadow-[0_2px_10px_rgba(15,23,42,0.05)]">
            ...
            <p className="mt-3 text-sm leading-6 text-neutral-500">
              {error
                ? "La connexion à la base de données a échoué. Reconnectez-vous puis réessayez."
        ...
        {!loading && team && (
          <>
            {/* En-tête équipe */}
            <header className="anim-fade-up rounded-3xl border border-neutral-200/80 bg-white p-6 shadow-[0_2px_10px_rgba(15,23,42,0.05)] md:p-8">
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[.25em] text-neutral-400">Espace d&apos;équipe</p>
                ...
                <Link
                  href="/team"
                  className="g3-btn g3-btn-ghost w-fit shrink-0 rounded-full"
                >
                  Toutes mes équipes
                </Link>
              </div>
            ...
            <section
              className="anim-fade-up anim-delay-1 rounded-3xl border border-neutral-200/80 bg-white p-6 shadow-[0_2px_10px_rgba(15,23,42,0.05)] md:p-8"
