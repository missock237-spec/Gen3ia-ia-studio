...
interface Wallet { currency: string; balanceMinor: number; reservedMinor: number; availableMinor: number; }
...
export default function BillingPage() {
  ...
  return <main style={styles.main}>
    <section style={styles.card}>
      ...
      <p style={styles.note}>Choisissez librement le montant de votre recharge sur la page de paiement Chariow. Le solde est crédité uniquement après confirmation du paiement par le webhook signé de Chariow.</p>
