...
const DEFAULT_INPUT_PER_MILLION: Record<AIProvider, number> = { openai: n(process.env.COST_OPENAI_INPUT_EUR_PER_1M, 2.5), anthropic: n(process.env.COST_ANTHROPIC_INPUT_EUR_PER_1M, 3), groq: n(process.env.COST_GROQ_INPUT_EUR_PER_1M, 0.6), openrouter: n(process.env.COST_OPENROUTER_INPUT_EUR_PER_1M, 1.5), glm: n(process.env.COST_GLM_INPUT_EUR_PER_1M, 1), huggingface: n(process.env.COST_HF_INPUT_EUR_PER_1M, 0.8) };
const DEFAULT_OUTPUT_PER_MILLION: Record<AIProvider, number> = { openai: n(process.env.COST_OPENAI_OUTPUT_EUR_PER_1M, 10), anthropic: n(process.env.COST_ANTHROPIC_OUTPUT_EUR_PER_1M, 15), groq: n(process.env.COST_GROQ_OUTPUT_EUR_PER_1M, 0.8), openrouter: n(process.env.COST_OPENROUTER_OUTPUT_EUR_PER_1M, 5), glm: n(process.env.COST_GLM_OUTPUT_EUR_PER_1M, 3), huggingface: n(process.env.COST_HF_OUTPUT_EUR_PER_1M, 3) };
